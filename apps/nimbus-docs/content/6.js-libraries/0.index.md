...
| <span class="icon-lib-status icon-check"> :icon{name="material-symbols:check-circle-outline-rounded"}</span> | Magic Debounce | [Link](js-libraries/magic-debounce) | :badge[v3.0.1] | <a href="https://www.npmjs.com/package/@vlalg-nimbus/magic-debounce" target="_blank">NPM</a> | <span class="npm-badge">![npm](https://img.shields.io/npm/dt/@vlalg-nimbus/magic-debounce?style=plastic)</span> |
...
- <a href="https://www.npmjs.com/package/@vlalg-nimbus/magic-debounce" target="_blank">Magic Debounce</a>
::
