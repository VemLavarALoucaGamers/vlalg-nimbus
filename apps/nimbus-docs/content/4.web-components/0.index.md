...
|---|---|---|---|---|---|
| <span class="icon-lib-status icon-check"> :icon{name="material-symbols:check-circle-outline-rounded"}</span> | Github Stars Button | [Link](web-components/github-stars-button) | :badge[v1.0.3] | <a href="https://www.npmjs.com/package/@vlalg-nimbus/github-stars-button" target="_blank">NPM</a> | <span class="npm-badge">![npm](https://img.shields.io/npm/dt/@vlalg-nimbus/github-stars-button?style=plastic)</span> |
