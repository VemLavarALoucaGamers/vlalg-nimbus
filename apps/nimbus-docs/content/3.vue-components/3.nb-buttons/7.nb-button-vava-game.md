...
| display     | String     | 'ib'    | Defines the display type. Accepts **ib** and **b**. |
...
| paddingYBorder    | Number     |  0.5    | Defines border padding-top and padding-bottom. |
| paddingXContent    | Number     |  0.5      | Defines button content padding-left and padding-right. |
| paddingYContent    | Number     |  0.5    | Defines button content padding-top and padding-bottom. |
