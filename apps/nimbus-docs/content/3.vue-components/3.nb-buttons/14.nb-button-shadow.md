...
| marginTop    | Number     |  0    | Defines button margin-top. |
| marginBottom    | Number     |  0    | Defines button margin-bottom. |
| marginRight    | Number     |  0    | Defines button margin-right. |
| marginLeft    | Number     |  0    | Defines button margin-left. |
