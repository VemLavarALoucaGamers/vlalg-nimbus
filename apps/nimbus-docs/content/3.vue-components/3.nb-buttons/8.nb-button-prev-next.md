...
| ariaLabelPrev     | String     | 'Preview Button'      | Defines the aria-label attribute for the preview button (screen readers). |
| ariaLabelNext     | String     | 'Next Button'      | Defines the aria-label attribute for the next button (screen readers). |
