...
| titlePrev     | String     | ''      | Tooltip text shown when hovering over the preview button. |
| titleNext     | String     | ''      | Tooltip text shown when hovering over the next button. |
...
| paddingY    | Number     |  10    | Defines button content padding-top and padding-bottom. |
...
| ------- | :--------- | :---------------------------- |
| clicked | MouseEvent \| KeyboardEvent | Fired when the button is clicked (mouse or Enter/Space). Receives the native DOM event as first argument. |
...
<template>
  <NbButtonPrevNext
    ...
    theme="light"
    aria-label-prev="Previous button"
