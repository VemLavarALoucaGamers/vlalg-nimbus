...
| <span class="icon-lib-status icon-check"> :icon{name="material-symbols:check-circle-outline-rounded"}</span> | nb-inputs | :badge[v7.0.3] | <a href="https://www.npmjs.com/package/@vlalg-nimbus/nb-inputs" target="_blank">NPM</a> | <span class="npm-badge">![npm](https://img.shields.io/npm/dt/@vlalg-nimbus/nb-inputs?style=plastic)</span> |
