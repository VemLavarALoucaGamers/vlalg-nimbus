...
| <span class="icon-lib-status icon-check"> :icon{name="material-symbols:check-circle-outline-rounded"}</span> | nb-inputs | :badge[v4.0.0] | <a href="https://www.npmjs.com/package/@vlalg-nimbus/nb-inputs" target="_blank">NPM</a> | <span class="npm-badge">![npm](https://img.shields.io/npm/dt/@vlalg-nimbus/nb-inputs?style=plastic)</span> |
| <span class="icon-lib-status icon-check"> :icon{name="material-symbols:check-circle-outline-rounded"}</span> | nb-loaders | :badge[v1.0.0] | <a href="https://www.npmjs.com/package/@vlalg-nimbus/nb-loaders" target="_blank">NPM</a> | <span class="npm-badge">![npm](https://img.shields.io/npm/dt/@vlalg-nimbus/nb-loaders?style=plastic)</span> |
