...
This is a toggle component with 3D flip animation effect for [Vue.js 3+](https://vuejs.org/).

::NbSelectsToggleFlipTest
::
...
:sandbox{src="https://stackblitz.com/edit/nimbus-qq4dwb-dpm9o4gp?embed=1&file=src%2Fcomponents%2FCompToggleFlip.vue&hideExplorer=1&hideNavigation=1&hidedevtools=1&terminalHeight=0&devtoolsheight=0&theme=dark&ctl=1"}
...
| clicked | MouseEvent \| KeyboardEvent | Fired when the toggle is clicked. Receives the native DOM event as first argument. |
