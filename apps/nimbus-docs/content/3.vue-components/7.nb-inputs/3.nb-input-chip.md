...
[`NbInputChip`](/vue-components/nb-inputs/nb-input-chip) **masks** (`input-mask`) use the same peer dependency as [`NbInput`](/vue-components/nb-inputs/nb-input): [`vue-the-mask@0.11.1`](https://www.npmjs.com/package/vue-the-mask/v/0.11.1). Tokens and behaviour are documented under [Input mask (`input-mask`)](/vue-components/nb-inputs/nb-input#input-mask-input-mask).
