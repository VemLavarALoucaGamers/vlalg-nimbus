...
| name | Value type | Default | Description |
| ------- | :--------- | :------ | :---------------------------- |
| lightLineColor | String | `#353734` | Base line color in light theme |
| lightCircleColor | String | `#353734` | Base circle border color in light theme |
| lightActiveColor | String | `#272936` | Active step border color in light theme |
| lightDoneColor | String | `#272936` | Done step color in light theme |
| lightFinishedColor | String | `#000000` | Finished state color in light theme |

### Theme Colors (Dark)

| name | Value type | Default | Description |
| ------- | :--------- | :------ | :---------------------------- |
| darkLineColor | String | `#353734` | Base line color in dark theme |
| darkCircleColor | String | `#353734` | Base circle border color in dark theme |
| darkActiveColor | String | `#272936` | Active step border color in dark theme |
| darkDoneColor | String | `#272936` | Done step color in dark theme |
| darkFinishedColor | String | `#000000` | Finished state color in dark theme |
