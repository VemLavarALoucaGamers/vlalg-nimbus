<template>
	...
	>
      ...
      <input
        ...
        type="checkbox"
        :disabled="disabled"
        :class="['component__input', `component__input--${mode}`]"
        @change="handleChange"
      />
      <label
        :for="`${nbId}-input`"
...
const props = defineProps({
  ...
  mode: {
    ...
    default: 'skewed',
    validator: value => {
      return ['skewed', 'flip'].includes(value)
    }
  },
	textEnable: {
		type: String,
    ...
    .component__input {
      &.component__input--flip {
        &:checked {
          & + .component__button {
            &:after {
              background: v-bind('styleButtonColorOn') !important;
            }
        ...
        & + .component__button {
          &:hover {
            &:after {
              ...
              background: v-bind('styleButtonColorOnHover') !important;
            }
            &:before {
              color: v-bind('styleTextColorOffHover');
              background: v-bind('styleButtonColorOffHover') !important;
            }
          }
          &:after {
            color: v-bind('styleTextColorOn');
            background: v-bind('styleButtonColorOn') !important;
          }
          &:before {  
            color: v-bind('styleTextColorOff');
            background: v-bind('styleButtonColorOff') !important;
          }
        }
      }
