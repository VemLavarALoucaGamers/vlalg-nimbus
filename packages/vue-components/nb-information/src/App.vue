  ...
  <div class="container-fluid test-page">
    <div class="row">
      <div class="col-md-10 col-md-offset-1 test-page__title">
        <h2>Test page</h2>
        <p class="test-page__component-name"><strong>Component:</strong> NbInformation</p>
    ...
    <div v-if="btType === 'card'" class="row">
      <div class="col-xs-12 col-md-10 col-md-offset-1 test-page__content"
        style="margin-top: 50px; margin-bottom: 50px;">
        <h4 class="test-page__content-tile">NbCard</h4>
...
const NbCard = defineAsyncComponent(() => import('@components/NbCard.vue'))

const btType = ref('card')
</script>
